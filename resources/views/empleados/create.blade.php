...
<form action="{{ route('empleados.store') }}" method="POST">
    ...
    <div class="row">
        ...
        <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control" id="CI" name="CI" value="{{ old('CI') }}" required maxlength="8" pattern="\d{8}" inputmode="numeric" oninput="this.value = this.value.replace(/[^0-9]/g, '');" title="Debe contener exactamente 8 dígitos numéricos">
        </div>
    </div>
