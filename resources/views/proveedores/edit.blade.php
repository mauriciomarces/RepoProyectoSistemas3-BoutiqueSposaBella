            ...
            <div class="card">
                <div class="card-header" style="background-color: #8E805E; color: white;">
                    <h3 class="card-title mb-0">
                        <i class="fas fa-edit me-2"></i>Editar Proveedor #{{ $proveedor->ID_proveedor }}
                    </h3>
                </div>
                    ...
                    <form action="{{ route('proveedores.update', $proveedor->ID_proveedor) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('tipo_proveedor') is-invalid @enderror"
                                ...
                                name="tipo_proveedor"
                                required>
                                <option value="" disabled {{ old('tipo_proveedor', $proveedor->tipo_proveedor) ? '' : 'selected' }}>Seleccione un tipo...</option>
                                <option value="Telas" {{ old('tipo_proveedor', $proveedor->tipo_proveedor) == 'Telas' ? 'selected' : '' }}>Telas</option>
                                <option value="Accesorios" {{ old('tipo_proveedor', $proveedor->tipo_proveedor) == 'Accesorios' ? 'selected' : '' }}>Accesorios</option>
                                <option value="Mercería" {{ old('tipo_proveedor', $proveedor->tipo_proveedor) == 'Mercería' ? 'selected' : '' }}>Mercería</option>
                                <option value="Maquinaria" {{ old('tipo_proveedor', $proveedor->tipo_proveedor) == 'Maquinaria' ? 'selected' : '' }}>Maquinaria</option>
                                <option value="Servicios" {{ old('tipo_proveedor', $proveedor->tipo_proveedor) == 'Servicios' ? 'selected' : '' }}>Servicios</option>
